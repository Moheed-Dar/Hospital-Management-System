            ...
            <div className="max-w-7xl w-full flex flex-col lg:flex-row items-center lg:items-center gap-12">
                ...
                <div className="flex-1 w-full space-y-8 text-center md:text-left">
                    ...
                    <div className="flex justify-center lg:justify-start">
                        <button className="relative overflow-hidden px-8 py-3 rounded-xl font-semibold text-lg text-white bg-gradient-to-r from-green-500 to-blue-600 shadow-lg transition-all duration-300 hover:shadow-2xl hover:scale-105 animate-glow">
                            <span className="relative z-10">Find Doctors</span>
                            <span className="absolute inset-0 bg-gradient-to-r from-blue-600 to-green-500 opacity-0 hover:opacity-100 transition-opacity duration-500"></span>
                        </button>
                    </div>
